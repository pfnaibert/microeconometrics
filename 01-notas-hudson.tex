...
\betavechat = \betavec +
\left( \sum_{i=1}^{N} \Xmat_{i}' \Xmat_{i} \right)^{-1}
\left( \sum_{i=1}^{N} \Xmat_{i}' \vvec_{i} \right)
\end{align*}

\vspace{-1 em}
\begin{align*}
	\yvec_{i} = \Xmat_{i} \betavec + \onevec c_{i} + \uvec_{i}
	\implies
...
\betavechat = \betavec +
\left( \sum_{i=1}^{N} \Xmat_{i}' \Xmat_{i} \right)^{-1}
\left( \sum_{i=1}^{N} \Xmat_{i}' \onevec c_{i} \right)
+
\left( \sum_{i=1}^{N} \Xmat_{i}' \Xmat_{i} \right)^{-1}
\left( \sum_{i=1}^{N} \Xmat_{i}' \uvec_{i} \right)
\end{align*}
...
O modelo linear de \textbf{efeitos individuais não observados}:
...
\noindent
Sabendo que 
$\ddot{X} = ( I_{N} \otimes \Mzero ) X$
e
$\ddot{\mbs{u}} = ( I_{N} \otimes \Mzero ) \mbs{u}$,
definimos:
...
\E \left\{
\left[  
X' ( I_{N} \otimes \Mzero )( I_{N} \otimes \Mzero ) X 
\right]^{-1}
\left[ 
X' ( I_{N} \otimes \Mzero )( I_{N} \otimes \Mzero ) \mbs{u}
\right]
\right\}
\\
\Aboxed{
...
\E \left\{
\left[  
X' ( I_{N} \otimes \Mzero ) X 
\right]^{-1}
\left[ 
X' ( I_{N} \otimes \Mzero ) \mbs{u}
\right]
\right\} }
\end{align*}
...
&=
\E \left[
X' ( I_{N} \otimes \Mzero ) ( I_{N} \otimes \Mzero ) 
\mbs{u} \mbs{u}'
( I_{N} \otimes \Mzero ) ( I_{N} \otimes \Mzero ) X
\right]
\\ &=
\E \left[
X' ( I_{N} \otimes \Mzero ) \mbs{u} \mbs{u}' ( I_{N} \otimes \Mzero ) X
\right]
\end{align*}
\end{description}
...
\item [Recheio':]
\begin{align*}
\E \left[ X' ( I_{N} \otimes \Mzero ) \right]
\sigma^2_{u} I_{NT}
\E \left[ ( I_{N} \otimes \Mzero ) X \right]
=
\sigma^2_{u}
\E \left[ X' ( I_{N} \otimes \Mzero ) X \right]
\end{align*}
\end{description}

\noindent
\red{ $( I_{N} \otimes \Mzero )$ é uma matrix de dimensão $NT \times NT$, visto que $I_{N}$ é $N\times N$ e $\Mzero$ é $T \times T$.}
...
X' ( I_{N} \otimes \Mzero ) X
\right]^{-1} \right\}
\sigma_{u}^{2} \E\left[ X' ( I_{N} \otimes \Mzero ) X \right]
\E \left\{ \left[
X' ( I_{N} \otimes \Mzero ) X
\right]^{-1} \right\}
\\  &=
...
\sigma_{u}^{2} I_{NT}
\\
\Aboxed{ \Var( \mbs{\beta}^{FE} ) &= \sigma_{u}^{2} \cdot  \E\left[ X' ( I_{N} \otimes \Mzero ) X \right] }
\end{align*}
