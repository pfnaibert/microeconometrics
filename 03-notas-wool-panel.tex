...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{lem}[Continuous mapping theorem]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{lem}[Asymptotic Equivalence Lemma]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{teo}[\textbf{Weak Law of Large Numbers (WLLN)}]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{teo}[\textbf{Central Limit Theorem (CLT)}, Lindberg-Levy]
Let $\seq{\wbold_{i}:i=1,2,\dots}$ be a sequence of independent, identically distributed (iid) $G \times 1$ random vectors such that
...
\noindent where,
$\boxed{\Abold \equiv E(\xvec' \xvec)}$ (\red{see Corollary 3.1}).
...
Therefore, by \blue{Slutsky's Theorem} (\red{Lemma 3.4}), 
