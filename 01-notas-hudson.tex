...
$\boxed{ \E \left[ \mbs{u} \mbs{u}'| \Xmat \right] = \sigma^2 \Imat_{N} }$.
Assim, 
...
\noindent
\citet[C.7 -- Estimating Systems of Equations by OLS and GLS. p.1643-179]{wool-2010} \\
...
\paragraph{FE.2:} Posto pleno de $\E( \Xmat_{i}' \Omega^{-1} \Xmat_{i} )$ (para inverter a matriz).
$\posto[ \E( \Xmat_{i}' \Omega^{-1} \Xmat_{i} ) ]  = K$.
...
\begin{align*}
	\Mzero &=
	\Imat_{T} - T^{-1} \mbs{1}_{T} \mbs{1}_{T}'
	=
	\Imat_{T} - \mbs{1}_{T} (\mbs{1}_{T}' \mbs{1}_{T})^{-1} \mbs{1}_{T}'.
\end{align*}

\noindent
A matriz $\Mzero$ é idempotente e simétrica.

\begin{align*}
	\Mzero \mbs{x} &= \mbs{x} - \overline{\mbs{x}} \mbs{1}_{T}
	= \ddot{\mbs{x}}.
\end{align*}
...
\vspace{-1 em}
\begin{align*} 
\Mzero \mbs{y}_{i} &= \Mzero X_{i} \mbs{\beta} + \Mzero ( c_{1} \mbs{1}_{T} ) + \Mzero \mbs{u}_{i},
\quad i = 1, \dots, N.
\end{align*}

\vspace{-1 em}
\begin{align*} 
\Mzero ( c_{1} \mbs{1}_{T} ) = 
( \Imat_{T} - T^{-1} \mbs{1}_{T} \mbs{1}_{T}' ) c_{i} \mbs{1}_{T} 
=
c_{i} \mbs{1}_{T} - T^{-1} c_{i} \mbs{1}_{T} \mbs{1}_{T}' \mbs{1}_{T} 
=
c_{i} \mbs{1}_{T} - c_{i} \mbs{1}_{T} 
\implies
\boxed{ \Mzero ( c_{1} \mbs{1}_{T} ) = 0 }
\end{align*}
...
e
$\ddot{\mbs{u}} = ( \Imat_{N} \otimes \Mzero ) \mbs{u}$,
definimos:
...
\right]^{-1}
\left[ 
X' ( \Imat_{N} \otimes \Mzero )( \Imat_{N} \otimes \Mzero ) \mbs{u}
\right]
\right\}
\\
\Aboxed{
...
\\ &=
\E \left[
X' ( \Imat_{N} \otimes \Mzero ) \mbs{u} \mbs{u}' ( \Imat_{N} \otimes \Mzero ) X
\right]
\end{align*}
\end{description}
...
\noindent
\red{ $( \Imat_{N} \otimes \Mzero )$ é uma matrix de dimensão $NT \times NT$, visto que $\Imat_{N}$ é $N\times N$ e $\Mzero$ é $T \times T$.}
...
\sigma_{u}^{2} \Imat_{NT}
\\
\Aboxed{ \Var( \mbs{\beta}^{FE} ) &= \sigma_{u}^{2} \cdot  \E\left[ X' ( \Imat_{N} \otimes \Mzero ) X \right] }
\end{align*}
...
\item [FD.3:] Homoscedasticidade:
	$\E(\mbs{e}_{i} \mbs{e}_{i}' \,|\, X_{i}, c_{i}) = \sigma_{e}^{2} \Imat_{T-1}$.
\end{enumerate}
...
\left[ \Xmat' \left( \Imat_{N} \otimes \widehat{\Omega}^{-1} \right) \mbs{y} \right]
\end{align*}
...
\left( X' (\Imat_{N} \otimes \Omega^{-1}) \mbs{y} \right).
\end{align}
...
\Omega 
= 
\E(\mbs{v}_{i} \mbs{v}_{i}') = \sigma^{2}_{u} \Imat_{T} + \sigma_{c}^{2} \mbs{1}_{T} \mbs{1}_{T}'
\end{align*}
...
\widehat{\Omega}
= 
\hat{\sigma}^{2}_{u} \Imat_{T} + \hat{\sigma}_{c}^{2} \mbs{1}_{T} \mbs{1}_{T}'
\end{align*}
...
\left[ X' (\Imat_{N} \otimes \widehat{\Omega}^{-1}) \mbs{y} \right].
\end{align}
...
\begin{align*}
	\Mzero &= 
	\Imat_{N} - \mbs{1}_{N} ( \mbs{1}_{N}' \mbs{1}_{N} )^{-1} \mbs{1}_{N}'
	= 
	\Imat_{N} - N^{-1} \mbs{1}_{N} \mbs{1}_{N}' 
\end{align*}
...
\begin{align*}
\Mzero \mbs{x} &= 
( \Imat_{N} - N^{-1} \mbs{1}_{N} \mbs{1}_{N}' ) \mbs{x} 
= 
...
\begin{align*}
\Mzero \mbs{1} &= 
( \Imat_{N} - N^{-1} \mbs{1}_{N} \mbs{1}_{N}' ) \mbs{1}_{N}
= 
